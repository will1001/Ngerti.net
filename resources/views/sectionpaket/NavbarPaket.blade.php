<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="{{ asset('css/sectionpaket/paket.css') }}" rel="stylesheet">
        <link href="{{ asset('css/sectionpaket/NavbarPaket.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <script src="{{ asset('js/sectionpaket/tutorLoad.js') }}"></script>
    </body>
    </html>
