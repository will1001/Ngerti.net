...
@section('content')
    ...
    <section id="paketgroup">
        <div class="row">
            <div class="col-md-12">
                <a href="/paketgroup" class="text-dark text-center"><h1>Paket Group</h1> </a>
                <div class="text-center">
                  <img src="/images/group.png" alt="paket" />
                </div>
    ...
    <div class="container">
        <form class="needs-validation" novalidate>
          ...
          <div class="form-row">
            <div class="form-group">
              <label for="formGroupExampleInput">Jumlah Group</label>
              <input type="number"  min="2" max="4" placeholder="Isi Jumlah Group yang diinginkan" value="" class="form-control" id="formGroupExampleInput" required>
              <div class="invalid-feedback">
                Jumlah group
              </div>
            </div>
